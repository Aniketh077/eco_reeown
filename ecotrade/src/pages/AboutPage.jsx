...
const AboutPage = () => {
  ...
  return (
    <div className="min-h-screen pt-20 pb-16 bg-gray-50">
      {/* Hero Section */}
      <section className="py-16 sm:py-20 md:py-24 bg-gradient-to-br from-[#131921] via-[#232f3e] to-[#131921] text-white">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-6 sm:mb-8 tracking-tight">About Reeown</h1>
            <p className="text-lg sm:text-xl md:text-2xl text-gray-300 mb-8 sm:mb-10 leading-relaxed font-normal">
              Leading the way in sustainable technology with premium refurbished electronics for everyone
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/products">
                <Button variant="secondary" size="lg" className="bg-[#ffd814] hover:bg-[#f7ca00] text-[#131921] font-semibold">Shop Now</Button>
              </Link>
              <Link to="/contact">
                <Button variant="outline" size="lg" className="border-2 border-white text-white hover:bg-white hover:text-[#131921] font-semibold">
                  Contact Us
                </Button>
              </Link>
            </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8 max-w-5xl mx-auto">
            {stats.map((stat, index) => (
              <div key={index} className="text-center p-4 sm:p-6 rounded-lg hover:bg-gray-50 transition-colors">
                <div className="text-3xl sm:text-4xl md:text-5xl font-bold text-[#B12704] mb-2 tracking-tight">
                  {stat.number}
                </div>
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 sm:gap-12">
            <div className="bg-white p-8 sm:p-10 rounded-lg shadow-sm hover:shadow-md transition-shadow text-center">
              <div className="bg-orange-50 w-16 h-16 sm:w-20 sm:h-20 rounded-full flex items-center justify-center mx-auto mb-6">
        ...
        <div className="container mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 max-w-7xl mx-auto">
            {values.map((value, index) => (
              <div key={index} className="bg-gray-50 p-6 sm:p-8 rounded-lg shadow-sm text-center hover:shadow-lg transition-all duration-200 border border-gray-200 hover:border-orange-300">
                <div className="bg-orange-50 w-14 h-14 sm:w-16 sm:h-16 rounded-full flex items-center justify-center mx-auto mb-5">
                  <value.icon className="h-7 w-7 sm:h-8 sm:w-8 text-orange-600" />
                </div>
      ...
      {/* Why Choose Us */}
      <section className="py-16 sm:py-20 bg-gradient-to-br from-[#131921] to-[#232f3e] text-white">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="text-center mb-12 sm:mb-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 max-w-7xl mx-auto">
            <div className="text-center p-6 bg-white/5 rounded-lg hover:bg-white/10 transition-colors">
              ...
              <p className="text-gray-300 text-sm sm:text-base">Free shipping on all refurbished devices across India</p>
            </div>
            ...
            <div className="text-center p-6 bg-white/5 rounded-lg hover:bg-white/10 transition-colors">
              ...
              <p className="text-gray-300 text-sm sm:text-base">Every device is thoroughly tested and certified before sale</p>
            </div>
            ...
            <div className="text-center p-6 bg-white/5 rounded-lg hover:bg-white/10 transition-colors">
              ...
              <p className="text-gray-300 text-sm sm:text-base">Dedicated customer support team available 24/7</p>
            </div>
            ...
            <div className="text-center p-6 bg-white/5 rounded-lg hover:bg-white/10 transition-colors">
              ...
              <p className="text-gray-300 text-sm sm:text-base">Reducing e-waste through sustainable refurbishment</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 sm:py-20 bg-white">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/products">
                <Button variant="primary" size="lg" className="bg-[#ffd814] hover:bg-[#f7ca00] text-[#131921] font-semibold">Start Shopping</Button>
              </Link>
              <Link to="/contact">
                <Button variant="outline" size="lg" className="border-2 border-gray-300 hover:border-[#131921] font-semibold">Get in Touch</Button>
              </Link>
            </div>
          </div>
        </div>
